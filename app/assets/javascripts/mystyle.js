$( document ).ready(function() {
  ...
  html_new_answer += "<div class=\"listquestion\"><input type=\"text\" value=\"\" name=\"interview[questions]["+question_id+"][answers][" + answer_id + "][id]\" style=\"display: none\" />"
  ...
  html_new_answer += " <input type=\"checkbox\" name=\"interview[questions]["+question_id+"][answers][" + answer_id + "][is_correct]\"/> Is correct</div></div>";
...
$("#add_question").live("click",function(){
  ...
  html_new_question += "<div class=\"listquestion\"><p>Question</p>"
  ...
  html_new_question +=    "<div class=\"listquestion\"><input type=\"text\" placeholder=\"Choice content...\" name=\"interview[questions]["+ question_id +"][answers][1][content]\" /> <input type=\"checkbox\" name=\"interview[questions]["+ question_id + "][answers][1][is_correct]\"/> Is correct"
  html_new_question +=  "</div></div></div>"
  html_new_question += " <a class=\"add_answer\" answer_max_number=\"1\" question_number=\""+ question_id +"\">Add answer</a>"
  html_new_question +=  "<br /><br /></div_question></div>";
